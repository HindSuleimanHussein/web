        ...
        <header>
            <ul>
                <li><a href="https://www.bbc.com/sport/football">
                        <img src="./images/icons8-football.png" alt="This is a football icon" width="50" height="50">
                    </a></li>
...
<div class="containerFoot">
    <footer>
        <ul>
            <li>@2023 Hind Suleiman Hussein 1202416</li>
            <li><a href="mailto:hindsuleimanh@gmail.com">Email Me</a></li>
            <li>059-4427454</li>
        </ul>
    </footer>
</div>
